...
public class Ctg extends JFrame {
    private Container k;
    private ImageIcon i;
    private JLabel il,nm,li,b3,j3;
    private Font f1,f2,f3,f6;
    private JButton b1;
    ...
    Ctg(){
        ...
        this.setTitle("Chittagong");                          //Title
      ...
      //Button Design:
       ...
       k.add(b1);                                         //Added to the window.
        ...
        b1.addActionListener(new ActionListener(){         //take the "Click" as an input.
          ...
          CTG_cohos nj= new CTG_cohos();                    //Created object will help to automatically call the constructor and proceed.
       ...
       //Action Code for Button "2.General Hospital Service"
        b1.addActionListener(new ActionListener(){          //take the "Click" as an input.
               @Override
                public void actionPerformed(ActionEvent e){ //Performs the particular work for the Button.
                     dispose();                             //Helps not to open a new window.
           CTG_HOS nj= new CTG_HOS();                       //Created object will help to automatically call the constructor and proceed.
           nj.setLocationRelativeTo(null);
           nj.setVisible(true);                             //makes Visible.
                }
        });
       ...
       k.add(b1);                                       //Added to the window.
        ...
        b1.addActionListener(new ActionListener(){          //take the "Click" as an input.
               @Override
                public void actionPerformed(ActionEvent e){ //Performs the particular work for the Button.
                     dispose();                             //Helps not to open a new window.
                     CTG_diagco nj= new CTG_diagco();       //Created object will help to automatically call the constructor and proceed.
           nj.setLocationRelativeTo(null);
           nj.setVisible(true);                             //makes Visible.
       ...
       //Action Code for Button "4.General Diagnosis Center"
        b1.addActionListener(new ActionListener(){          //take the "Click" as an input.
               @Override
                public void actionPerformed(ActionEvent e){ //Performs the particular work for the Button.
                     dispose();                             //Helps not to open a new window.
            CTG_diag nj= new CTG_diag();                    //Created object will help to automatically call the constructor and proceed.
           nj.setLocationRelativeTo(null);
           nj.setVisible(true);                             //makes Visible.
                }
    });
       ...
       k.add(b1);                                       //Added to the window.
        ...
        b1.addActionListener(new ActionListener(){          //take the "Click" as an input.
               @Override
                public void actionPerformed(ActionEvent e){  //Performs the particular work for the Button.
                     dispose();                              //Helps not to open a new window.
          CTG_emr nj= new CTG_emr();                         //Created object will help to automatically call the constructor and proceed.
           nj.setLocationRelativeTo(null);
          nj.setVisible(true);                             //makes Visible.
                }
    });
       ...
       k.add(b1);                                       //Added to the window.
        ...
        b1.addActionListener(new ActionListener(){            //take the "Click" as an input.
         ...
         ob.setBounds(0, 0,1375,800);                         //size & position.
   ...
   public void fun(){
       ...
       nm.setBounds(785,150,320,50);                     //Label size & position.
